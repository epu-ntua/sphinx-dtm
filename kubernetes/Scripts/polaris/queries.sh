...
#  'connection.url'           = 'jdbc:postgresql://sphinx-postgres-polaris:5432/sphinx',
...
#  'value.converter.schema.registry.url' = 'http://schema-registry-service-polaris:8081',
...
# CERTIFICATIONS SIEM
#
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS SIEM_CERTIFICATIONS_VULNERS;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS ACS_SCA;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS ACS_SCA_DETAILED;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS CERTIFICATIONS_AVRO delete topic;"
...
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "CREATE STREAM DTM_ALERT (id VARCHAR KEY, \"id\" VARCHAR, \"objects\" ARRAY<VARCHAR>, \"flow_id\" VARCHAR, \"event_type\" VARCHAR) WITH (KAFKA_TOPIC='dtm-alert', VALUE_FORMAT='JSON', PARTITIONS=3);"
...
#
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS FDCE_REPORT_TOPIC;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS FDCE_REPORT_TOPIC_EXPLODED delete topic;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS FDCE_REPORT_TOPIC_FILTERED delete topic;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS FDCE_REPORT_TOPIC_AVRO delete topic;"
...
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS HP_CURRENTLY_CONNECTED_IPS_CONNECTIONS;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "CREATE STREAM HP_CURRENTLY_CONNECTED_IPS (id INT KEY, \"Connected\" ARRAY<VARCHAR>) WITH (KAFKA_TOPIC='hp-currently-connected-ips', PARTITIONS=3, VALUE_FORMAT='JSON');"
...
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS HP_INTERVAL_INFO_FIRST;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS HP_INTERVAL_INFO_FILTERED;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "CREATE STREAM HP_INTERVAL_INFO (id INT KEY, \"id\" VARCHAR, \"name\" VARCHAR, \"cpu_activity\" VARCHAR, \"memory_usage\" VARCHAR, \"upload\" VARCHAR, \"download\" VARCHAR, \"db_usage\" VARCHAR) WITH (KAFKA_TOPIC='hp-interval-info', PARTITIONS=3, VALUE_FORMAT='JSON');"
...
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS HP_MOST_USED_FIRST;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS HP_MOST_USED_FILTERED;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "CREATE STREAM HP_MOST_USED (id INT KEY, \"honey_name\" VARCHAR, \"honey_id\" VARCHAR, \"usernames\" ARRAY<VARCHAR>, \"passwords\" ARRAY<VARCHAR>) WITH (KAFKA_TOPIC='hp-most-used', PARTITIONS=3, VALUE_FORMAT='JSON');"
...
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "CREATE STREAM HP_SERVICE_COUNTERS (id INT KEY, \"name\" VARCHAR, \"stat\" VARCHAR) WITH (KAFKA_TOPIC='hp-service-counters', PARTITIONS=3, VALUE_FORMAT='JSON');"
...
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "CREATE STREAM HP_STATIC_INFO (id INT KEY, \"name\" VARCHAR, \"isActive\" VARCHAR, \"Id\" VARCHAR, \"active_services\" VARCHAR, \"flavour\" VARCHAR, \"general_info\" VARCHAR) WITH (KAFKA_TOPIC='hp-static-info', PARTITIONS=3, VALUE_FORMAT='JSON');"
...
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS SIEM_ALERTS_EXPLODED delete topic;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS SIEM_ALERTS_AVRO delete topic;"
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "CREATE STREAM SIEM_ALERTS (id VARCHAR KEY, \"id\" VARCHAR, \"name\" VARCHAR, \"attackType\" VARCHAR, \"start\" VARCHAR, \"end\" VARCHAR, \"eventsCount\" VARCHAR, \"data\" ARRAY<VARCHAR>, \"query\" VARCHAR, \"tag\" VARCHAR, \"riskScore\" VARCHAR, \"severity\" VARCHAR, \"uuid\" VARCHAR) WITH (KAFKA_TOPIC='siem-alerts', PARTITIONS=3, VALUE_FORMAT='JSON');"
...
# ALERTS TABLE
#
kubectl exec -it ${ksqldbserver:0:${#ksqldbserver}} /bin/bash -- ksql -e "DROP STREAM IF EXISTS ID_ALERTS delete topic;"
